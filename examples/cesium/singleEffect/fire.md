...
head:
  - - meta
    - name: keywords
      content: "cesium.js,webgl,singleEffect,粒子（火焰）"
outline: deep
---
# 粒子（火焰）
...
完整源码见 [在线案例编辑器](https://z2586300277.github.io/three-cesium-examples/#/?navigation=CesiumJS&classify=singleEffect&id=fire)。

## 小结

- 建议先在 [案例编辑器](https://z2586300277.github.io/three-cesium-examples/#/?navigation=CesiumJS&classify=singleEffect&id=fire) 运行，再对照源码逐步修改参数加深理解
