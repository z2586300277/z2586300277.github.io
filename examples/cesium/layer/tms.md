...
description: "本案例展示 **OGC- tms服务 ** 的实现。涉及：Cesium Viewer 初始化、Cesium 影像图层。"
head:
  - - meta
    - name: keywords
      content: "cesium.js,webgl,layer,OGC- tms服务"
outline: deep
---
# OGC- tms服务
...
本案例展示 **OGC- tms服务 ** 的实现。涉及：Cesium Viewer 初始化、Cesium 影像图层。
...
- 建议先在 [案例编辑器](https://z2586300277.github.io/three-cesium-examples/#/?navigation=CesiumJS&classify=layer&id=tms) 运行，再对照源码逐步修改参数加深理解
