...
head:
  - - meta
    - name: keywords
      content: "cesium.js,webgl,applyExample,键盘控制飞行"
outline: deep
---
# 键盘控制飞行
...
完整源码见 [在线案例编辑器](https://z2586300277.github.io/three-cesium-examples/#/?navigation=CesiumJS&classify=applyExample&id=controlModel)。

## 小结

- 建议先在 [案例编辑器](https://z2586300277.github.io/three-cesium-examples/#/?navigation=CesiumJS&classify=applyExample&id=controlModel) 运行，再对照源码逐步修改参数加深理解
