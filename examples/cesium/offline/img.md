...
description: "本案例展示 **影像 ** 的实现。涉及：Cesium Viewer 初始化、Cesium 影像图层。"
head:
  - - meta
    - name: keywords
      content: "cesium.js,webgl,offline,影像"
outline: deep
---
# 影像
...
本案例展示 **影像 ** 的实现。涉及：Cesium Viewer 初始化、Cesium 影像图层。
...
- 建议先在 [案例编辑器](https://z2586300277.github.io/three-cesium-examples/#/?navigation=CesiumJS&classify=offline&id=img) 运行，再对照源码逐步修改参数加深理解
