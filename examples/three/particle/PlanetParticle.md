...
head:
  - - meta
    - name: keywords
      content: "three.js,webgl,particle,粒子效果的行星"
outline: deep
---
# 粒子效果的行星
...
完整源码见 [在线案例编辑器](https://z2586300277.github.io/three-cesium-examples/#/?navigation=ThreeJS&classify=particle&id=PlanetParticle)。

## 小结

- 建议先在 [案例编辑器](https://z2586300277.github.io/three-cesium-examples/#/?navigation=ThreeJS&classify=particle&id=PlanetParticle) 运行，再对照源码逐步修改参数加深理解
