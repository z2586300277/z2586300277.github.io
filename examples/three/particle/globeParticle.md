...
description: "地球粒子：Scene / Camera / Renderer 渲染管线、相机交互控制器、ShaderMaterial / RawShaderMaterial 自定义 GLSL（粒子）"
head:
  - - meta
    - name: keywords
      content: "three.js,particle,globeParticle,顶点着色器,片元着色器,uniform 驱动"
outline: deep
---
...
[▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=ThreeJS&classify=particle&id=globeParticle)
...
- 建议先在 [在线案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=ThreeJS&classify=particle&id=globeParticle) 运行，再对照源码修改 uniform / 参数加深理解


- 上一篇：[真实火焰](/examples/three/particle/realFire)
- 下一篇：[发散粒子](/examples/three/particle/spreadPartile)
