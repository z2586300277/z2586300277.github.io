...
head:
  - - meta
    - name: keywords
      content: "three.js,shader,waterSky,顶点着色器,片元着色器,uniform 驱动"
outline: deep
---
...
完整源码：[GitHub](https://github.com/z2586300277/three-cesium-examples/blob/dev/threeExamples/shader/waterSky.js)
...
- 下一篇：[天空云](/examples/three/shader/cloudShader)
