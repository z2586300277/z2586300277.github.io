...
description: "切换ShaderToy：Scene / Camera / Renderer 渲染管线、相机交互控制器、ShaderMaterial / RawShaderMaterial 自定义 GLSL（着色器）"
head:
  - - meta
    - name: keywords
      content: "three.js,shader,changeShaderToy,顶点着色器,片元着色器,uniform 驱动"
outline: deep
---
...
[▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=ThreeJS&classify=shader&id=changeShaderToy)
...
- 建议先在 [在线案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=ThreeJS&classify=shader&id=changeShaderToy) 运行，再对照源码修改 uniform / 参数加深理解


- 上一篇：[溶解](/examples/three/shader/dissolve)
- 下一篇：[波浪效果](/examples/three/shader/waterA)
