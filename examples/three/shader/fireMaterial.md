...
head:
  - - meta
    - name: keywords
      content: "three.js,webgl,shader,火焰材质"
outline: deep
---
# 火焰材质
...
- 建议先在 [案例编辑器](https://z2586300277.github.io/three-cesium-examples/#/?navigation=ThreeJS&classify=shader&id=fireMaterial) 运行，再对照源码逐步修改参数加深理解
