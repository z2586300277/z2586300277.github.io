...
head:
  - - meta
    - name: keywords
      content: "three.js,webgl,shader,波涛海浪"
outline: deep
---
# 波涛海浪
...
- 建议先在 [案例编辑器](https://z2586300277.github.io/three-cesium-examples/#/?navigation=ThreeJS&classify=shader&id=raningSea) 运行，再对照源码逐步修改参数加深理解
