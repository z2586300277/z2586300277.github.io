...
description: "本案例展示 **扩散圈** 的实现。涉及：相机交互控制器、requestAnimationFrame 渲染循环。"
head:
  - - meta
    - name: keywords
      content: "three.js,webgl,basic,扩散圈"
outline: deep
---
# 扩散圈
...
本案例展示 **扩散圈** 的实现。涉及：相机交互控制器、requestAnimationFrame 渲染循环。
...
- 建议先在 [案例编辑器](https://z2586300277.github.io/three-cesium-examples/#/?navigation=ThreeJS&classify=basic&id=扩散圈) 运行，再对照源码逐步修改参数加深理解
