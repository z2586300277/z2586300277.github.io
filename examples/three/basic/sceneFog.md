...
description: "Three.js Scene/Camera/Renderer 基础搭建。主流程在 `animate`、`getFog`。"
head:
  - - meta
    - name: keywords
      content: "three.js,cesium,webgl,场景雾化,基础案例"
outline: deep
---
...
Three.js Scene/Camera/Renderer 基础搭建。主流程在 `animate`、`getFog`。
