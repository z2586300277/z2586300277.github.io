...
description: "Three.js Scene/Camera/Renderer 基础搭建。主流程在 `animate`、`getObjectViews`。"
head:
  - - meta
    - name: keywords
      content: "three.js,cesium,webgl,模型视图,基础案例"
outline: deep
---
...
Three.js Scene/Camera/Renderer 基础搭建。主流程在 `animate`、`getObjectViews`。
