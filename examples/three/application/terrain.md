...
head:
  - - meta
    - name: keywords
      content: "three.js,webgl,application,程序化地形生成"
outline: deep
---
# 程序化地形生成
...
完整源码见 [在线案例编辑器](https://z2586300277.github.io/three-cesium-examples/#/?navigation=ThreeJS&classify=application&id=terrain)。

## 小结

- 建议先在 [案例编辑器](https://z2586300277.github.io/three-cesium-examples/#/?navigation=ThreeJS&classify=application&id=terrain) 运行，再对照源码逐步修改参数加深理解
