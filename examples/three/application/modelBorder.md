...
head:
  - - meta
    - name: keywords
      content: "three.js,application,modelBorder,BufferGeometry"
outline: deep
---
...
Three.js WebGL 场景，加载外部模型，技术点：BufferGeometry。打开在线案例可查看最终画面。
...
- 下一篇：[模型粒子化](/examples/three/application/modelParticle)
