...
description: "跳跃动画：Scene / Camera / Renderer 渲染管线、相机交互控制器、ShaderMaterial / RawShaderMaterial 自定义 GLSL（应用场景）"
head:
  - - meta
    - name: keywords
      content: "three.js,application,jumpAnimate,顶点着色器,片元着色器,uniform 驱动"
outline: deep
---
...
[▶ 在线运行案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=ThreeJS&classify=application&id=jumpAnimate)
...
- 建议先在 [在线案例](https://z2586300277.github.io/three-cesium-examples/#/codeMirror?navigation=ThreeJS&classify=application&id=jumpAnimate) 运行，再对照源码修改 uniform / 参数加深理解


- 上一篇：[网格材质](/examples/three/application/girdMaterial)
- 下一篇：[点云第一人称漫游,碰撞检测](/examples/three/application/pointCloudFpsOctree)
